 ...
 */
public class BackgroundImageSwitcher extends ImageSwitcher {
    ...
    public BackgroundImageSwitcher(Context context, AttributeSet attrs) {
        super(context, attrs);
        inflateAndInit(context);
    }

    public BackgroundImageSwitcher(Context context) {
        super(context);
        inflateAndInit(context);
    }
    ...
    public void cacheBackgroundAtPosition(Pager pager, int position) {
    ...
    public void updateCurrentBackground(Pager pager, final AnimationDirection direction) {
    ...
    public void updateCurrentBackgroundAsync(Pager pager, final AnimationDirection direction) {
