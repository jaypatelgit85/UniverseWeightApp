 ...
 */
public class PagerCardHead extends FrameLayout {

    private ImageView headBackgroundImageView;

    public PagerCardHead(Context context) {
        super(context);
        init(context);
    }

    public PagerCardHead(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PagerCardHead(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void animateHeight(int targetHeight, int duration, int delay) {
        ...
        cardHeadHeightAnimation.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                patel.jay.personal.universeweightapp.PagerCardHead.this.setLayoutParams(cardHeaderLayoutParams);
            }
        });
