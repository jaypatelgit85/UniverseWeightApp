...
//        this.setOverScrollMode(OVER_SCROLL_NEVER);
    ...
    public CardData getDataFromAdapterDataset(int position) {
        return ((PagerViewAdapter) this.getAdapter()).getDataset().get(position);
    }
    ...
    public boolean expand() {
        PagerViewAdapter adapter = (PagerViewAdapter) getAdapter();
