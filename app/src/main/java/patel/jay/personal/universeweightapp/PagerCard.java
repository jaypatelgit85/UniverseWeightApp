 ...
 */
public class PagerCard extends FrameLayout {

    private PagerCardContent ecPagerCardContentList;
    private boolean animationInProgress;
    private boolean cardExpanded;

    public PagerCard(Context context) {
        super(context);
    }
    ...
    public PagerCard(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onFinishInflate() {
        ...
        try {
            ecPagerCardContentList = (PagerCardContent) getChildAt(0);
//            ecPagerCardListContent.disableScroll();
        } catch (Exception e) {
            throw new IllegalStateException("Invalid children element in PagerCard.");
        }
    }
    ...
    public boolean expand() {
        ...
        final Pager pager = (Pager) getParent();
        final PagerView pagerView = (PagerView) pager.getParent();
...
//        ecPagerCardListContent.disableScroll();
    ...
    public PagerCardContent getEcPagerCardContentList() {
